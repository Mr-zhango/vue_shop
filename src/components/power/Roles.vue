<template>
  <div>
              ...
              <el-col :span="21">
                ...
                <el-row :class="[i2 === 0 ? '' : 'bdtop', 'vcenter']" v-for="(item2, i2) in item1.children" :key="item2.id">
                  ...
                  <el-col :span="4">
                    ...
                    <i class="el-icon-caret-right"/><!-- -> 图标 -->
                  </el-col>
                  <!-- 右边三级权限 -->
                  <el-col :span="20">
    ...
    <el-dialog title="分配权限" :visible.sync="setRightDialogVisible" width="50%" @close="setRightDialogClosed">
      <el-tree :data="rightsList" :props="treeProps" ref="treeRef" show-checkbox node-key="id" default-expand-all :default-checked-keys="defKeys"/>
